...
def descriptionEmbed():
  embed = discord.Embed(title="Project Manager Bot Commands", description="Welcome to the productivity manager! We currently offer systems to deal with: tasks, meetings, reminders, pomodoro timers,, and daily inspiration. With this bot, you can begin commands with the prefix ! and separate arguments with , (a comma followed by a space). https://replit.com/@trinLeaf/superpositronBot#usermanual.md ", color = 0xCFB9A5)
  return embed
